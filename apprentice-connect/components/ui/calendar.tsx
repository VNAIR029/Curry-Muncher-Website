    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-gray-300 hover:bg-gray-100 hover:scale-110 active:scale-95"
        ),
        ...
        day: cn(
          "inline-flex items-center justify-center rounded-md text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 hover:scale-110 active:scale-95"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-green-600 text-white hover:bg-green-700 hover:text-white focus:bg-green-700 focus:text-white",
        day_today: "bg-gray-100 text-green-600",
        day_outside:
          "day-outside text-gray-400 aria-selected:bg-gray-100/50 aria-selected:text-gray-400",
        day_disabled: "text-gray-400 opacity-50",
        day_range_middle:
          "aria-selected:bg-gray-100 aria-selected:text-green-600",
